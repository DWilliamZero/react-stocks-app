    ...
    return (
      <div className="hero-data" >
        ...
        <div className='primary'>
          <div className=''>
            <h2>Website: <a href={this.state.data.website} target='_blank'>{this.state.data.website}</a></h2>
          ...
          <div className='logo'>
            <a href={this.state.data.website} target='_blank'><img src={this.state.logo} alt={this.state.companyName} /></a>
          </div>
        </div>
